            ...
            <div className="mt-8">
                ...
                <div className="mt-8 flex justify-between items-center">
                    <div>
                        ...
                        <label className="ml-2 font-medium text-base" for="remember">Remember for 31 days</label>
                    </div>
                    <button className="font-medium text-base text-violet-500">Forgot Password</button>
                </div>
                <div className="mt-8 flex flex-col gap-y-4">
                    <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl bg-violet-500 text-white text-lg font-bold">Sign In</button>
